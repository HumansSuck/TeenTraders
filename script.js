...
function confirmOrder(event) {
    ...
    // Simulate saving order without a server for now
    storeOrder(orderDetails); // This uses localStorage as a mock database

    alert("Order confirmed for " + buyerName + "! Payment method: " + paymentMethod);
